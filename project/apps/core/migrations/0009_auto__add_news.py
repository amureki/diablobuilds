...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_news', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 23, 0, 0))),
        ))
    ...
    models = {
        ...
        u'core.news': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
